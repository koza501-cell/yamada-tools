      ...
      <Popover.Root open={open} onOpenChange={handleOpenChange}>
        <Popover.Trigger asChild>
          <button
            ...
            aria-expanded={open}
            className={`w-full px-3 py-2 border rounded-lg text-left bg-white hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-kon/40 ${ariaInvalid ? "border-red-400" : "border-gray-200"} ${className}`}
          >
