...
const relatedToolsMap: Record<string, string[]> = {
  ...
  "corporate-tax-calculator": ["incorporation-simulator", "director-salary-optimizer", "consumption-tax", "hojin-hoken-simulator", "kyosai-simulator"],
  "incorporation-simulator": ["corporate-tax-calculator", "director-salary-optimizer", "freelance-tax-calculator", "business-loan-simulator", "kyosai-simulator"],
  ...
  "jutaku-loan": ["rent-vs-buy", "loan-interest-calculator", "repayment-simulator", "business-loan-simulator"],
  ...
  // ===== 新finance tools =====
  "business-loan-simulator": ["kyosai-simulator", "factoring-simulator", "hojin-hoken-simulator", "jutaku-loan", "loan-interest-calculator"],
  "kyosai-simulator": ["business-loan-simulator", "hojin-hoken-simulator", "factoring-simulator", "incorporation-simulator", "retirement-simulator"],
  "factoring-simulator": ["business-loan-simulator", "kyosai-simulator", "hojin-hoken-simulator", "loan-interest-calculator"],
  "hojin-hoken-simulator": ["kyosai-simulator", "business-loan-simulator", "corporate-tax-calculator", "incorporation-simulator"],
