...
export default function LifeInsuranceCalculatorPage() {
  ...
  return (
    <>
      <IntroSection title="生命保険 必要保障額計算機" paragraphs={["万が一の際に遺族の生活維持に必要な生命保険の保障額がわかります。年収・家族構成・住宅ローン・貯蓄・遺族年金見込みを入力するだけで算出。", "子どもの教育費・遺族の生活費・葬儀費用などを加味した必要保障額と、現在の保険との過不足も確認できます。", "登録不要・完全無料。生命保険の見直しや新規加入を検討している方に最適です。"]} />
