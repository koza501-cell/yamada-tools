...
const breadcrumbJsonLd = {
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "住宅ローン計算機", "item": "https://yamada-tools.jp/finance/jutaku-loan"}
  ]
};
  ...
  return (
    <>
      ...
      <IntroSection
        title="住宅ローンシミュレーター"
        paragraphs={[
          "借入金額・金利・返済期間を入力すると月々の返済額・総返済額・利息総額がわかります。変動金利と固定金利の比較、5年ルール・125%ルールのシミュレーションに対応しています。",
            ...
            <tbody>
              {[
                ...
                <tr key={amount} className="border-t border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="py-2 px-4 text-kon">{r20}</td>
                  <td className="py-2 px-4 text-danger">{r30}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <div className="max-w-4xl mx-auto px-4 mt-8 mb-4">
        ...
        >
          ...
          <div>
            <p className="text-sm font-semibold text-kon group-hover:text-ai">【2026年最新】住宅ローンシミュレーション完全ガイド｜変動vs固定・借入可能額</p>
