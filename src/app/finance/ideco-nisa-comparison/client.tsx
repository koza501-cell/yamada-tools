          ...
          <div className="prose prose-sm max-w-none text-gray-600 space-y-6">
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 rounded-xl p-4">
                <h4 className="font-bold text-kon mb-2">年収600万円以上の会社員 → iDeCo優先</h4>
                <p className="text-sm">
              ...
              <div className="bg-gray-50 rounded-xl p-4">
                <h4 className="font-bold text-kon mb-2">自営業・フリーランス → iDeCoが最強</h4>
                <p className="text-sm">
              ...
              <div className="bg-gray-50 rounded-xl p-4">
                <h4 className="font-bold text-kon mb-2">専業主婦・主夫 → NISAのみ</h4>
                <p className="text-sm">
