  ...
  "@graph": [
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        { "@type": "Question", "name": "固定残業代（みなし残業）を超えた場合の計算は？", "acceptedAnswer": { "@type": "Answer", "text": "固定残業代は所定の残業時間分を給与に含めた制度です。実際の残業時間が固定残業時間を超えた場合、超えた分の残業代は別途支払われる義務があります。このツールでは固定残業時間を入力すると、超過分の残業代を自動計算します。" } },
