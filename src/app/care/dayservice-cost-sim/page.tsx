      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: { "@type": "Answer", text: "介護保険の単位数 × お住まいの地域単価 × 自己負担割合(1〜3割)で計算されます。これに食費(1回あたり500〜800円が目安)などの実費が加わります。平均的な加算と食費を含めた月額目安がわかります。" },
        },
        {
          "@type": "Question",
          name: "計算結果は正確?",
        ...
        },
        {
          "@type": "Question",
          name: "限度額を超えるとどうなる?",
          acceptedAnswer: { "@type": "Answer", text: "月額の支給限度額(要介護度ごとに決まっています)を超えると、超過分は全額自己負担になります。限度額を超えると警告でお知らせします。ケアマネジャーと相談して回数を調整するのが一般的です。" },
        },
        {
          "@type": "Question",
