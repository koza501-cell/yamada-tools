...
const blogPosts = [
  ...
  {
    path: '/blog/hoikushi-haichi-kijun-guide',
    title: '保育士配置基準の完全ガイド【令和8年度版】',
    audience: '保育園 経営者',
    audienceColor: 'amber',
    summary:
  ...
  {
    path: '/blog/kogaku-kaigo-service-guide',
    title: '高額介護サービス費の完全ガイド【令和8年度版】',
    audience: '介護家族',
    audienceColor: 'green',
    summary:
