...
const faq = [
  ...
  },
  {
    ...
    answer: "数万文字程度まで問題なく処理できます。非常に長いテキストの場合は、分割して変換すると確実です。",
  },
  {
...
export const metadata: Metadata = generateToolMetadata({
  ...
  tool,
  longDescription: "全角半角を一括変換。数字、英字、カタカナ、スペースの変換に対応。Excel作業やデータ入力に便利な無料ツール。中小企業・個人事業主・フリーランスのビジネス文書作成に最適。日本国内サーバーで安全処理、SSL暗号化対応、登録不要・完全無料・60分自動削除。freee・マネーフォワード等の会計ソフトとも連携可能。",
