...
export const metadata: Metadata = generateToolMetadata({
  customTitle: "ふりがな変換ツール【無料・登録不要】漢字にふりがな自動付与",
  tool,
  longDescription: "ふりがなツール（フリガナツール）で漢字にふりがなを自動付与。ひらがな・カタカナ・ローマ字に対応。文章をコピペするだけで瞬時に変換。教育現場・外国人向け資料作成・名簿のフリガナ付けに最適。完全無料・登録不要・日本国内サーバーで安心処理。",
  keywords: [
    'ふりがなツール',
    'フリガナツール', 
    'ふりがな変換',
