...
export const metadata: Metadata = generateToolMetadata({
  ...
  tool,
  longDescription: "和暦西暦を簡単変換。令和・平成・昭和・大正・明治に対応。履歴書作成や書類作成に便利な無料ツール。中小企業・個人事業主・フリーランスのビジネス文書作成に最適。日本国内サーバーで安全処理、SSL暗号化対応、登録不要・完全無料・60分自動削除。freee・マネーフォワード等の会計ソフトとも連携可能。",
