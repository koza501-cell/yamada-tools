...
const seoContent = {
  intro: "郵便番号から住所を検索、または住所から郵便番号を検索。日本郵便のデータを使用した正確な情報がわかります。",
  useCases: [
...
export const metadata: Metadata = generateToolMetadata({
  ...
  tool,
  longDescription: "郵便番号から住所を検索、または住所から郵便番号を検索。日本郵便のデータを使用した正確な情報がわかります。中小企業・個人事業主・フリーランスのビジネス文書作成に最適。日本国内サーバーで安全処理、SSL暗号化対応、登録不要・完全無料・60分自動削除。freee・マネーフォワード等の会計ソフトとも連携可能。",
