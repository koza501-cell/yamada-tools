...
const faq = [
  {
    question: "全銀フォーマットとは何ですか？どうやって作りますか？",
    answer: "全国銀行協会が定めた振込データの標準形式で、企業が銀行に振込依頼をする際に使用されます。給与振込や取引先への支払いなどで広く利用されています。本ツールでExcelやCSVファイルをアップロードし、列を指定するだけで全銀フォーマット（.txt）ファイルを自動生成できます。手作業でのデータ作成は不要です。",
  },
  {
  ...
  {
    question: "ExcelやCSVから変換できますか？全銀データはどのソフトで作れますか？",
    answer: "はい、ExcelやCSVファイルをアップロードして全銀フォーマットに変換できます。列の並び順を指定するだけで簡単に変換可能です。会計ソフト（弥生・freee等）やExcelマクロでも作成できますが、本ツールはブラウザだけで登録不要・無料で作成可能です。",
  },
  {
    question: "振込手数料はどうなりますか？区分の設定はできますか？",
    answer: "振込手数料は各銀行の規定に従います。先方負担・当方負担の設定が可能で、振込先ごとに個別に設定することもできます。なお、全銀データ自体に手数料金額は含まれません。",
  },
  {
    question: "給与振込と総合振込はどう違いますか？",
    answer: "給与振込は従業員への給与支払い用、総合振込は取引先への支払い用です。データ形式は同じですが、銀行への依頼方法が異なる場合があります。本ツールはどちらにも対応しており、給与振込データの作成にも最適です。",
  },
  {
    question: "データは安全に処理されますか？",
    answer: "変換処理はすべてブラウザ内で完結します。データはサーバーに送信されません。給与・口座情報が外部に漏れる心配はありません。",
  },
  {
    question: "文字コードは何ですか？SJISとUTF-8どちらに対応していますか？",
    answer: "Shift-JIS（SJIS）とUTF-8の両方に対応しています。全銀フォーマットの標準はShift-JISで、多くの銀行システムもShift-JISを要求するためデフォルトはShift-JISです。",
  },
  {
...
const bankFormatSeoContent = {
  intro: "全銀フォーマットは、給与振込から取引先への支払い、返金処理まで、幅広い場面で使われています。",
  useCases: [
    { title: "毎月の給与振込（中小企業）", desc: "従業員20〜50名の給与振込で、毎月Excelの一覧から全銀フォーマットを作成。手書きや手入力のミスがなくなり、月末の作業が10分で片づきます。" },
