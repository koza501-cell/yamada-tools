...
const faqs = [
  {
    ...
    questions: [
      {
        q: "本当に無料で使えますか？",
        a: "はい、完全無料でご利用いただけます。会員登録も不要で、すべての機能をお使いいただけます。",
      },
      {
        q: "利用回数に制限はありますか？",
        a: "無料プランは1日5回までご利用いただけます。より多くお使いになる場合はPROプランをご検討ください。詳しくは「適正利用ガイドライン」または料金ページをご確認ください。",
      },
      {
        q: "ファイルサイズの上限はありますか？",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "申し訳ございませんが、自動化ツール、ボット、スクレイピングツールなどを使用した大量アクセスはご遠慮ください。このような利用が検知された場合、IPアドレス単位でアクセスを制限する場合があります。",
      },
    ],
  },
  {
