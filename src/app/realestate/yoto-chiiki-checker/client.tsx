...
const faqItems = [
  { question: "用途地域とは何ですか？", answer: "都市計画法に基づいて土地の用途を13種類に分けたもので、各エリアで建てられる建物の種類・規模が制限されます。" },
  ...
  { question: "用途地域が見つからない場合は？", answer: "都市計画区域外（農村・山間部・一部離島など）は用途地域が設定されていない場合があります。その場合、建物の用途制限は基本的に存在しませんが、農地法・自然公園法など別の法令が適用されるケースがあります。詳細は市区町村の都市計画部門（窓口またはウェブGIS）にお問い合わせください。" },
];
