    ...
    },
    {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": { "@type": "Answer", "text": "相続税の土地評価には、原則として国税庁が公表する「路線価」（公示価格の約80%水準）が使われます。地価公示データは相続税の直接の計算根拠ではありませんが、土地価値の大まかな目安として参考にすることができます。正確な相続税評価は税理士や税務署にご相談ください。" }
        },
        {
          "@type": "Question",
