...
export const metadata: Metadata = generateToolMetadata({
  ...
  tool,
  longDescription: "PDFにページ番号を追加。報告書や資料のページ管理に便利です。位置、フォント、開始番号などカスタマイズ可能。中小企業・個人事業主・フリーランスのビジネス文書作成に最適。日本国内サーバーで安全処理、SSL暗号化対応、登録不要・完全無料・60分自動削除。freee・マネーフォワード等の会計ソフトとも連携可能。",
