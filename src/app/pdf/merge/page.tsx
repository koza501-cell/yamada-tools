...
const faq = [
  ...
  },
  {
    ...
    answer: "はい。ファイルは日本国内のサーバーで処理され、10分後に自動削除されます。SSL暗号化通信で安全に転送されます。",
  },
  {
...
export const metadata: Metadata = generateToolMetadata({
  tool,
  longDescription:
    "複数のPDFファイルを1つに結合する無料オンラインツール。最大50ファイルまで対応。日本国内サーバーで処理するため、機密文書も安心してご利用いただけます。登録不要、ファイルは10分で自動削除。",
  keywords: [
    "PDF結合",
    "PDF まとめる",
    "PDF 1つにする",
