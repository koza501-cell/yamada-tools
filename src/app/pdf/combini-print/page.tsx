...
export const metadata: Metadata = generateToolMetadata({
  ...
  tool,
  longDescription: "コンビニ印刷で端が切れる問題を解決。PDF余白を自動追加。セブン・ローソン・ファミマ全対応。登録不要・無料。中小企業・個人事業主・フリーランスのビジネス文書作成に最適。日本国内サーバーで安全処理、SSL暗号化対応、登録不要・完全無料・60分自動削除。freee・マネーフォワード等の会計ソフトとも連携可能。",
  keywords: [
    "コンビニ印刷 端が切れる",
    "PDF 余白を追加",
    "セブンイレブン 印刷 切れる",
