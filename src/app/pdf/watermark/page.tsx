...
export const metadata: Metadata = generateToolMetadata({
  ...
  tool,
  longDescription: "PDFに透かし（ウォーターマーク）を追加。「社外秘」「SAMPLE」「DRAFT」など、文書の状態を明示できます。中小企業・個人事業主・フリーランスのビジネス文書作成に最適。日本国内サーバーで安全処理、SSL暗号化対応、登録不要・完全無料・60分自動削除。freee・マネーフォワード等の会計ソフトとも連携可能。",
...
export default function Page() {
  return (
    <>
      ...
      <ToolPage tool={tool} customH1="PDFに透かし・スタンプを追加する無料ツール — 社外秘・コピー禁止表示に" faq={faq} seoContent={seoContent} />
