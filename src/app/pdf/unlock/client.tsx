...
export default function UnlockClient({ faq }: UnlockClientProps) {
  ...
  return (
    <>
      ...
      <div className="bg-gray-50 border-l-4 border-gray-200 p-4 mx-4 mt-4 rounded-r-lg">
        <div className="flex items-start">
          <span className="text-kon text-xl mr-3">⚠️</span>
          <div>
            <h3 className="font-bold text-kon mb-1">ご利用上の注意</h3>
