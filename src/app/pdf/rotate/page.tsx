...
const faq = [
  {
    question: "複数ページや複数ファイルをまとめて回転できますか？",
    answer: "1つのPDF内の複数ページは一括で回転できます。全ページ一括または選択したページのみ操作可能で、ページサムネイルから選べます。複数の別々のPDFファイルを同時に処理することはできず、現在は1ファイルずつのご利用となります。",
  },
  { 
...
export default function Page() {
  return (
    <>
      ...
      <ToolPage tool={tool} customH1="PDFを回転する無料ツール — スキャンの向きズレを修正" faq={faq} seoContent={seoContent} />
