            ...
            <tbody>
              {[
                ...
                <tr key={i} className="border-t border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                  ...
                  <td className="py-2 px-4 text-blue-600 dark:text-blue-400">{row[4]}</td>
                  <td className="py-2 px-4 text-blue-600 dark:text-blue-400">{row[5]}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mt-8 mb-4">
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold text-purple-700 group-hover:text-purple-800">【2026年最新】失業保険はいくらもらえる？受給額・期間シミュレーション</p>
