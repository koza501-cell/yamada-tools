    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mt-8 mb-4">
          ...
          <Link
            href="/blog/fukugyou-zeikin-simulation-2026"
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold text-purple-700 group-hover:text-purple-800">【2026年最新】副業の税金はいくら？確定申告が必要な条件と節税方法</p>
