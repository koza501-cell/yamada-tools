  ...
  const seoContent = [
    {
      ...
      content: "iDeCoは掛けたお金が所得控除される「掛金控除」が最大のメリット。NISAは運用益が非課税になるのが特徴。iDeCoは原則60歳まで引き出せませんが、NISAはいつでも売却可能です。",
    },
    {
      title: "iDeCoの節税効果はいくら？年収別シミュレーション",
      content: "年収500万円の会社員は年間約8万円、年収800万円の方は年間約14万円の節税効果が期待できます。所得税率が高いほどiDeCoの節税効果は大きくなります。",
    },
    {
      title: "NISAが向いている人・iDeCoが向いている人",
      content: "若手や低所得の方はNISAがおすすめ。高所得や確定拠出年金に加入中の方はiDeCoの併用が有利。60歳前にお金が必要な場合はNISAを選びましょう。",
    },
    {
      title: "2024年の新NISA・iDeCo改正ポイント",
      content: "新NISAは非課税期間が無期限に。つみたて枠年120万円・成長投資枠年240万円、合計1800万円まで非課税。iDeCoは掛金控除の仕組みは変更なく継続中です。",
    },
  ];
