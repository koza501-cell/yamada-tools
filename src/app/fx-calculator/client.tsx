  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div ref={resultRef} className="space-y-6">
          ...
          {mode === "profit" && (
            <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-1">
                      標準ロット=100,000通貨、ミニ=10,000、マイクロ=1,000
                    </p>
                  </div>
              ...
              <details className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <summary className="font-bold text-gray-800 cursor-pointer">FX損益の計算方法とは</summary>
          ...
          {mode === "margin" && (
            <>
              ...
              <details className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <summary className="font-bold text-gray-800 cursor-pointer">ロスカットとは</summary>
                <p className="text-gray-600 text-sm mt-4 leading-relaxed">
          ...
          {mode === "swap" && (
            <>
              ...
              <details className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <summary className="font-bold text-gray-800 cursor-pointer">スワップポイントとは</summary>
                <p className="text-gray-600 text-sm mt-4 leading-relaxed">
          ...
          {mode === "tax" && (
            <>
              ...
              <details className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <summary className="font-bold text-gray-800 cursor-pointer">FXの確定申告が必要な条件</summary>
        ...
        <ToolFeedbackWidget toolSlug="fx-calculator" visible={true} />
