...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: baseUrl + "/pricing", lastModified: currentDate, changeFrequency: "monthly", priority: 0.7 },
    { url: baseUrl + "/legal", lastModified: currentDate, changeFrequency: "yearly", priority: 0.3 },
