...
export default function DateCalculatorPage() {
  ...
  const faqItems = [
    ...
    {
      q: "うるう年の計算はどうなりますか？",
      a: "うるう年も自動的に考慮されます。うるう年は4年に1度（西暦年が4で割り切れる年）ですが、100で割り切れる年はうるう年ではなく、400で割り切れる年は例外的にうるう年になります（例：2000年はうるう年、1900年はうるう年ではない）。",
    },
    {
    ...
    },
    {
      ...
      a: "本ツールには2024〜2027年の日本の祝日データが組み込まれています。国民の祝日・振替休日も含めて正確に計算できます。それ以降の年については祝日を含まない計算になる場合があります。",
    },
  ];
