...
const faq = [
  ...
  { question: "印刷に最適なDPIはいくつですか？", answer: "用途別の目安：①一般的なカラー印刷は300DPI、②ポスターなど大判印刷は150〜200DPI（離れて見るため低めでOK）、③名刺・パンフレットは350DPI以上、④Web表示は72〜96DPI、⑤新聞印刷は150〜200DPI。本ツールではDPIから推奨印刷サイズも自動計算します。" },
