...
export default function SepiaClient({ faq, seoContent }: Props) {
  ...
  const download = () => {
    ...
    a.download = fileName.replace(/\.[^.]+$/, "") + "_sepia_yamada-tools.png";
      ...
      <div className="max-w-4xl mx-auto px-4">
        <nav className="mb-6 text-sm">
          <ol className="flex items-center gap-2 text-gray-500">
            ...
            <li>/</li>
            <li className="text-kon font-medium">セピア加工</li>
          </ol>
        </nav>

        <header className="text-center mb-8">
          <div className="text-5xl mb-4">🟤</div>
          <h1 className="text-3xl font-bold text-kon mb-2">セピア加工</h1>
          <p className="text-gray-600 dark:text-gray-300 text-lg">写真をレトロ・ヴィンテージ風に変換</p>
            ...
            <div>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 mb-4">
                <div className="flex items-center justify-between mb-2">
                  <label className="font-bold text-sm text-gray-700 dark:text-gray-200">セピアの強さ</label>
        ...
        {seoContent && (
          <section className="mt-8 bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-100 dark:border-gray-700">
            <h2 className="font-bold text-kon mb-4 text-lg">セピア加工とは？</h2>
