      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
          ...
          <div className="prose prose-sm max-w-none text-gray-600 space-y-4">
            ...
            <p>
              新NISAでは、生涯を通じて最大2,000万円まで非課税で運用できます（成長投資枠は最大1,200万円）。
              この枠を使い切ったら新たな投資はできませんが、売却すれば枠が復活するという特徴もあります。
            </p>
            <h3 className="font-bold text-gray-800">なぜ早く始めるべきか？</h3>
            <p>
              複利の力により、早く始めるほど資産が大きく育ちます。
              例えば、月10万円を　6年間、年刡5%で運用した場合、元本等が　6年間で評価額は著しく増えます。
            </p>
        ...
        <ToolFeedbackWidget toolSlug="nisa-simulator" visible={true} />
