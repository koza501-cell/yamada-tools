    ...
    <article className="max-w-4xl mx-auto px-4 py-8">
      ...
      <section className="mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-5">
            <h3 className="font-bold text-orange-700 mb-3">① 引越し業者への費用</h3>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-5">
            <h3 className="font-bold text-blue-700 mb-3">② 新居の初期費用</h3>
            <ul className="text-gray-700 text-sm space-y-1">
              <li>・敷金（家賃1〜2ヶ月分）</li>
              <li>・礼金（家賃0〜2ヶ月分）</li>
              <li>・仲介手数料（家賃1ヶ月分）</li>
      ...
      <section className="mb-10">
        ...
        <table className="min-w-full border border-gray-200 mb-6">
          ...
          <tbody>
            <tr><td className="px-3 py-3 border-b font-bold">同一市内（〜15km）</td><td className="px-3 py-3 border-b text-right">2.5〜4万円</td><td className="px-3 py-3 border-b text-right text-red-600">4〜6万円</td></tr>
            <tr><td className="px-3 py-3 border-b font-bold">同一県内（〜50km）</td><td className="px-3 py-3 border-b text-right">3〜5万円</td><td className="px-3 py-3 border-b text-right text-red-600">5〜8万円</td></tr>
            <tr><td className="px-3 py-3 border-b font-bold">近距離（〜200km）</td><td className="px-3 py-3 border-b text-right">4〜7万円</td><td className="px-3 py-3 border-b text-right text-red-600">7〜12万円</td></tr>
            <tr><td className="px-3 py-3 border-b font-bold">長距離（〜500km）</td><td className="px-3 py-3 border-b text-right">5〜10万円</td><td className="px-3 py-3 border-b text-right text-red-600">10〜18万円</td></tr>
            <tr><td className="px-3 py-3 border-b font-bold">遠距離（500km超）</td><td className="px-3 py-3 border-b text-right">7〜15万円</td><td className="px-3 py-3 border-b text-right text-red-600">15〜25万円</td></tr>
          </tbody>
        </table>
      ...
      <section className="mb-10">
        ...
        <table className="min-w-full border border-gray-200 mb-6">
          ...
          <tbody>
            <tr><td className="px-3 py-3 border-b font-bold">同一市内（〜15km）</td><td className="px-3 py-3 border-b text-right">5〜8万円</td><td className="px-3 py-3 border-b text-right text-red-600">8〜12万円</td></tr>
            <tr><td className="px-3 py-3 border-b font-bold">同一県内（〜50km）</td><td className="px-3 py-3 border-b text-right">6〜10万円</td><td className="px-3 py-3 border-b text-right text-red-600">10〜15万円</td></tr>
            <tr><td className="px-3 py-3 border-b font-bold">近距離（〜200km）</td><td className="px-3 py-3 border-b text-right">8〜13万円</td><td className="px-3 py-3 border-b text-right text-red-600">13〜20万円</td></tr>
            <tr><td className="px-3 py-3 border-b font-bold">長距離（〜500km）</td><td className="px-3 py-3 border-b text-right">12〜20万円</td><td className="px-3 py-3 border-b text-right text-red-600">20〜30万円</td></tr>
            <tr><td className="px-3 py-3 border-b font-bold">遠距離（500km超）</td><td className="px-3 py-3 border-b text-right">15〜25万円</td><td className="px-3 py-3 border-b text-right text-red-600">25〜40万円</td></tr>
          </tbody>
        </table>
      </section>
      ...
      <section className="mb-10">
        ...
        <table className="min-w-full border border-gray-200 mb-6">
          ...
          <tbody>
            <tr><td className="px-3 py-3 border-b font-bold">同一市内（〜15km）</td><td className="px-3 py-3 border-b text-right">8〜12万円</td><td className="px-3 py-3 border-b text-right text-red-600">12〜18万円</td></tr>
            <tr><td className="px-3 py-3 border-b font-bold">同一県内（〜50km）</td><td className="px-3 py-3 border-b text-right">10〜15万円</td><td className="px-3 py-3 border-b text-right text-red-600">15〜22万円</td></tr>
            <tr><td className="px-3 py-3 border-b font-bold">近距離（〜200km）</td><td className="px-3 py-3 border-b text-right">12〜20万円</td><td className="px-3 py-3 border-b text-right text-red-600">20〜30万円</td></tr>
            <tr className="bg-yellow-50"><td className="px-3 py-3 border-b font-bold">長距離（〜500km）</td><td className="px-3 py-3 border-b text-right font-bold">18〜30万円</td><td className="px-3 py-3 border-b text-right text-red-600 font-bold">30〜50万円</td></tr>
            <tr><td className="px-3 py-3 border-b font-bold">遠距離（500km超）</td><td className="px-3 py-3 border-b text-right">25〜40万円</td><td className="px-3 py-3 border-b text-right text-red-600">40〜70万円</td></tr>
          </tbody>
        </table>

        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
          <p className="text-lg font-bold text-blue-800 mb-2">🔧 あなたの引越し費用を計算！</p>
          <p className="text-gray-700 mb-4">人数・距離・時期を入力して、引越し費用の目安をシミュレーションしましょう。</p>
          <Link href="/realestate/moving-cost-calculator" className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-6 rounded-lg transition">
            → 引越し費用計算機を使う
          </Link>
        </div>
      </section>
      ...
      <section className="mb-10">
        ...
        <div className="bg-green-50 border-l-4 border-green-400 p-4 mb-6">
          ...
          <p className="text-gray-700">
            敷金8万＋礼金8万＋仲介手数料8.8万＋前家賃16万＋火災保険1.5万＋保証会社4万＋鍵交換2万＝<strong className="text-orange-600">約48万円</strong>
          </p>
        </div>
      </section>
      ...
      <section className="mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
            <p className="font-bold text-orange-600 mb-1">1. 繁忙期を避ける</p>
            <p className="text-gray-700 text-sm">3〜4月を避けると30〜50%安くなることも</p>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
            <p className="font-bold text-orange-600 mb-1">2. 複数社で見積もり</p>
            <p className="text-gray-700 text-sm">最低3社から見積もりを取って比較</p>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
            <p className="font-bold text-orange-600 mb-1">3. 平日・時間フリー</p>
            <p className="text-gray-700 text-sm">土日祝や時間指定を避けると割安</p>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
            <p className="font-bold text-orange-600 mb-1">4. 荷物を減らす</p>
            <p className="text-gray-700 text-sm">不用品は引越し前に処分・売却</p>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
            <p className="font-bold text-orange-600 mb-1">5. 自分で梱包</p>
            <p className="text-gray-700 text-sm">梱包サービスを使わず自力で</p>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
            <p className="font-bold text-orange-600 mb-1">6. 混載便を利用</p>
            <p className="text-gray-700 text-sm">他の荷物と一緒に運ぶと割安</p>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
            <p className="font-bold text-orange-600 mb-1">7. 敷金礼金ゼロ物件</p>
            <p className="text-gray-700 text-sm">初期費用を大幅に削減</p>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
            <p className="font-bold text-orange-600 mb-1">8. フリーレント物件</p>
            <p className="text-gray-700 text-sm">1〜2ヶ月家賃無料の物件も</p>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
            <p className="font-bold text-orange-600 mb-1">9. 仲介手数料の交渉</p>
            <p className="text-gray-700 text-sm">無料や半額の不動産会社も</p>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
            <p className="font-bold text-orange-600 mb-1">10. クレカ払いでポイント</p>
      ...
      <section className="mb-10">
        ...
        <div className="bg-gradient-to-r from-orange-500 to-amber-500 text-white rounded-lg p-6 text-center">
          <p className="text-lg font-bold mb-4">あなたの引越し費用をシミュレーション</p>
          <Link href="/realestate/moving-cost-calculator" className="inline-block bg-white text-orange-600 font-bold py-3 px-8 rounded-lg hover:bg-gray-100 transition">
            → 引越し費用計算機を使う
          </Link>
        </div>
      </section>
      ...
      <section className="mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Link href="/realestate/rental-cost-calculator" className="block bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md hover:border-orange-300 transition">
