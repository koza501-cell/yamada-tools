  ...
  return (
    <article className="max-w-[680px] mx-auto px-4 py-8">
      ...
      <div className="relative w-full h-48 md:h-64 mb-6 rounded-xl overflow-hidden">
        <img src={`/api/og?title=${encodeURIComponent("退職金の計算方法と相場")}&type=blog&category=${encodeURIComponent("転職・キャリア")}`} alt="退職金シミュレーション" className="w-full h-full object-cover" />
      </div>
