...
export default function SleepCalculatorPage() {
  ...
  return (
    <>
      <IntroSection title="睡眠時間最適化ツール" paragraphs={["起床時刻から逆算した最適な就寝時刻、または就寝時刻から最適な起床時刻がわかります。90分の睡眠サイクル（レム睡眠・ノンレム睡眠）に基づいて複数の候補時刻を提示。", "目覚めやすいタイミングで起きることで、スッキリとした目覚めを実現します。仮眠（パワーナップ）の最適時間も確認できます。", "登録不要・完全無料。睡眠の質改善や早起きの習慣化に取り組む方に最適です。"]} />
