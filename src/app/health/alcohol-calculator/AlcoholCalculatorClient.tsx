...
export default function AlcoholCalculatorPage() {
  ...
  return (
    <>
      <IntroSection title="アルコール分解時間計算機" paragraphs={["飲酒量・体重・性別を入力するとアルコールが体内から分解されるまでの時間がわかります。翌朝の血中アルコール残存量も確認可能。", "「飲んだ翌朝に運転しても大丈夫か」を数値で確認できます。肝臓の処理速度は体重1kgあたり約0.1gが目安です。", "登録不要・完全無料。二日酔い対策や翌朝の予定に合わせた飲酒量の目安把握に活用してください。"]} />
