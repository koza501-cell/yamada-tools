...
export default function PregnancyCalculatorPage() {
  ...
  return (
    <>
      <IntroSection title="妊娠週数・出産予定日計算機" paragraphs={["最終月経日または排卵日・受精日から妊娠週数・出産予定日がわかります。安定期（妊娠5ヶ月）の開始日や各マイルストーンも一覧で確認できます。", "妊婦健診のスケジュール（初診〜36週以降の週1回まで）と、各週での胎児の大きさ・発育の目安もわかります。", "登録不要・完全無料。妊娠中の方が健診計画を立てたり、妊娠週数を把握するのに役立ちます。"]} />
