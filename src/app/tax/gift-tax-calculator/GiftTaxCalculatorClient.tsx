...
export default function GiftTaxCalculatorPage() {
  ...
  return (
    <>
      <IntroSection title="贈与税計算機" paragraphs={["贈与金額・贈与者との関係（親・祖父母など直系尊属か否か）・受贈者の年齢を入力すると贈与税がわかります。", "暦年課税（年間110万円基礎控除）と相続時精算課税（2,500万円非課税・2024年改正で年110万円追加控除）を比較できます。", "登録不要・完全無料。生前贈与の計画立案や贈与税の概算把握に活用できます。"]} />
