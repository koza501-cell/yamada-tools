...
export default function FurusatoNozeiCalculatorPage() {
  ...
  return (
    <>
      <IntroSection title="ふるさと納税 控除上限額計算機" paragraphs={["年収と家族構成を入力するだけでふるさと納税の控除上限額（実質自己負担2,000円に収まる上限）がわかります。", "共働き・配偶者控除・扶養家族の有無など、よく混乱するケースも詳しく対応。ワンストップ特例と確定申告の選択判定も行います。", "登録不要・完全無料。今年のふるさと納税上限額を知りたい方に最適です。"]} />
