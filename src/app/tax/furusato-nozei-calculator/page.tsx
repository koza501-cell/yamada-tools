    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mt-8 mb-4">
          ...
          <Link
            href="/blog/furusato-nozei-simulation-2026"
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold text-purple-700 group-hover:text-purple-800">【2026年最新】ふるさと納税シミュレーション完全ガイド｜年収別の控除上限額</p>
