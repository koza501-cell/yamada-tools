    ...
    },
    {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": { "@type": "Answer", "text": "複数明細モードをONにすると、品名・金額・税率を行ごとに入力して一括計算できます。最大10行まで対応しており、合計税額と税込総額がわかります。" }
        },
        {
          "@type": "Question",
...
export default function ConsumptionTaxClient() {
          ...
          <div className="space-y-3">
            {[
              ...
              },
              {
                ...
                a: "本ツールの「複数明細モード」をONにすると、品名・金額・税率を行ごとに入力して一括計算できます。最大10行まで対応しており、合計税額と税込総額がわかります。"
              },
              {
