...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* ============================================================ */}
      {/* NEW: Niche Bento Section — directly after hero               */}
      {/* Strategic placement: orients new users immediately,           */}
      {/* before they see RecentTools (returning users) and other      */}
      {/* sections. Acts as the main "目的から選ぶ" gateway.            */}
      {/* ============================================================ */}
      <NicheBentoSection />
