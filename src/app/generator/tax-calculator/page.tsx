...
export const metadata: Metadata = generateToolMetadata({
  ...
  tool,
  longDescription: "税込価格から税抜価格、税抜価格から税込価格を計算。10%と8%（軽減税率）に対応しています。中小企業・個人事業主・フリーランスのビジネス文書作成に最適。日本国内サーバーで安全処理、SSL暗号化対応、登録不要・完全無料・60分自動削除。freee・マネーフォワード等の会計ソフトとも連携可能。",
