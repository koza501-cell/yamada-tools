      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
                ...
                {stamp.enabled && (
                  <div className="grid grid-cols-2 gap-3">
                    <select value={stamp.text} onChange={(e) => setStamp({...stamp, text: e.target.value})} className="bg-gray-50 border border-gray-300 rounded-lg px-3 py-2 text-sm">
                      <option value="請求書在中">請求書在中</option><option value="納品書在中">納品書在中</option><option value="見積書在中">見積書在中</option><option value="領収書在中">領収書在中</option><option value="履歴書在中">履歴書在中</option><option value="親展">親展</option><option value="重要">重要</option><option value="至急">至急</option><option value="バッテリー同梱なし">バッテリー同梱なし</option><option value="製品同梱">製品同梱</option><option value="取扱注意">取扱注意</option><option value="壊れ物注意">壊れ物注意</option>
                    </select>
            ...
            <div className={`space-y-6 ${professionalMode ? "lg:sticky lg:top-20" : ""}`}>
