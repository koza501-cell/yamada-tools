...
const faq = [
  ...
  {
    question: "印刷がずれる場合は？",
    answer: "詳細設定で位置を微調整できます。プリンターによってズレ具合が異なるため、まず1枚テスト印刷してから本番に進みましょう。",
  },
  {
...
export const metadata: Metadata = generateToolMetadata({
  ...
  tool,
  longDescription: "封筒の宛名印刷を無料で。長形3号・角形2号・洋形など全サイズ対応。郵便番号入力で住所自動補完。縦書き・横書き対応。300DPI高画質印刷でプロ品質の仕上がり。登録不要・スマホOK。ビジネス・個人どちらにも対応。中小企業・個人事業主・フリーランスのビジネス文書作成に最適。日本国内サーバーで安全処理、SSL暗号化対応、登録不要・完全無料・60分自動削除。",
