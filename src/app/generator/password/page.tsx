...
const faq = [
  ...
  },
  {
    ...
    answer: "可能であれば含めると安心です。大文字、小文字、数字、記号を組み合わせることで、パスワードの強度が大幅に向上します。",
  },
  {
...
export const metadata: Metadata = generateToolMetadata({
  ...
  tool,
  longDescription: "強力なパスワードを無料生成。文字数、記号の有無を選択可能。安全なランダムパスワードを作成。中小企業・個人事業主・フリーランスのビジネス文書作成に最適。日本国内サーバーで安全処理、SSL暗号化対応、登録不要・完全無料・60分自動削除。freee・マネーフォワード等の会計ソフトとも連携可能。",
