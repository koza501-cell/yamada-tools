...
export const metadata: Metadata = generateToolMetadata({
  ...
  tool,
  longDescription: "名前・数字をランダムに抽選するブラウザツール。忘年会の幹事決め、プレゼント交換、チーム分け、順番決めに対応。インストール・登録一切不要、完全無料。日本国内サーバーで安心。中小企業・個人事業主・フリーランスのビジネス文書作成に最適。日本国内サーバーで安全処理、SSL暗号化対応、登録不要・完全無料・60分自動削除。",
