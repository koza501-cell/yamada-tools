    ...
    <>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8">
          <h2 className="text-2xl font-bold text-kon dark:text-gray-300 mb-6">PDFに押せる電子印鑑を10秒で作成</h2>

          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            「PDFに電子印鑑を押したい」「無料で電子印鑑を作ってPDFに貼り付けたい」——そんな時に便利なのが本ツールです。名前を入力するだけで認印・角印・日付印を10秒で作成し、透過PNG形式で即ダウンロード。<a href="/pdf/text-input" className="text-kon dark:text-gray-300 hover:text-ai underline">PDFに文字を直接入力ツール</a>と組み合わせれば、PDFファイルに電子印鑑を直接押印・保存できます。在宅ワーク、テレワーク、ペーパーレス化を進めている企業様に多くご利用いただいています。
          </p>
          ...
          <ol className="text-gray-700 dark:text-gray-300 space-y-3 mb-4 list-decimal list-inside">
            ...
            <li className="leading-relaxed"><strong>PDFに配置・保存</strong>：山田ツールの<a href="/pdf/text-input" className="text-kon dark:text-gray-300 hover:text-ai underline">PDF文字入力ツール</a>でPDFを開き、印影画像を任意の位置にドラッグ＆ドロップ。サイズ調整後、PDFとして保存すれば完了です。</li>
          </ol>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          ...
          <ul className="text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            <li className="flex items-start gap-2"><span className="text-kon dark:text-gray-300 font-bold">・</span><strong>認印（みとめいん）</strong>：日常的に使う個人の丸印。苗字を彫刻。社内文書の確認や荷物の受け取りに使用</li>
            <li className="flex items-start gap-2"><span className="text-kon dark:text-gray-300 font-bold">・</span><strong>実印（じついん）</strong>：市区町村に登録した印鑑。不動産契約や法人設立など重要な法的手続きに必要。電子印鑑での代用は不可</li>
            <li className="flex items-start gap-2"><span className="text-kon dark:text-gray-300 font-bold">・</span><strong>角印（かくいん）</strong>：会社名が刻まれた四角い印鑑。請求書や見積書の社印として使用。本ツールで角印も作成可能</li>
            <li className="flex items-start gap-2"><span className="text-kon dark:text-gray-300 font-bold">・</span><strong>日付印</strong>：受領日や承認日を記録する印鑑。「2026.04.30 確認 山田」のように日付入りで作成可能</li>
          </ul>
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            本ツールで作成した印影は透過PNG形式でダウンロードされます。<strong>Word</strong>の場合は「挿入」→「画像」で配置し、「文字列の折り返し」を「前面」に設定すると署名欄の上に重ねられます。<strong>Excel</strong>も同様に画像挿入で配置可能です。<strong>PDF</strong>に直接押印したい場合は、山田ツールの<a href="/pdf/text-input" className="text-kon dark:text-gray-300 hover:text-ai underline">PDF文字入力ツール</a>または<a href="/pdf/stamp" className="text-kon dark:text-gray-300 hover:text-ai underline">PDF押印ツール</a>と組み合わせると、印刷不要でデジタル完結できます。
          </p>
