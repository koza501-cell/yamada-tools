...
export default function DirectorSalaryOptimizerPage() {
  ...
  const faqItems = [
    { question: "役員報酬の最適額はいくらですか？", answer: "法人の利益規模によって異なりますが、一般的に法人利益（役員報酬支払前）の60〜80%を役員報酬に設定し、法人税と個人の所得税・社会保険料のバランスを最適化します。本ツールで実際の売上・経費を入力すると最適額がわかります。" },
  ...
  return (
    <>
      <IntroSection title="役員報酬最適化シミュレーター" paragraphs={["法人の売上・経費を入力すると、法人税と個人の所得税・社会保険料の合計が最小になる役員報酬額がわかります。", "配偶者を役員にする場合の所得分散効果や、役員報酬ゼロにした場合との比較も一覧表示。", "登録不要・完全無料。新たに法人設立した方や役員報酬の見直しを検討している方に最適です。"]} />
        ...
        <div className="mt-6 bg-white rounded-xl border border-gray-200 shadow-sm p-5">
          ...
          <div className="space-y-4">
            {[
              {
                q: "役員報酬の最適額はいくらですか？",
                a: "法人の利益規模によって異なりますが、一般的に法人利益（役員報酬支払前）の60〜80%を役員報酬に設定し、法人に残る利益に対する法人税と個人の所得税・社会保険料のバランスを最適化します。本ツールで実際の売上・経費を入力すると最適額がわかります。",
              },
              {
                q: "役員報酬はゼロにしてもいいですか？",
