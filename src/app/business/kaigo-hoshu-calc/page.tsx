...
export const metadata: Metadata = {
  title: "介護報酬計算機｜訪問介護・デイサービス料金を自動計算【令和6年改定・無料】",
  description: "令和6年介護報酬改定に対応した無料計算ツール。訪問介護、通所介護（デイサービス）、居宅介護支援の単位数から介護報酬と自己負担額をワンタッチで計算。地域区分・加算減算対応。",
  keywords: ["介護報酬", "介護報酬計算", "訪問介護", "デイサービス", "通所介護", "居宅介護支援", "地域区分", "令和6年改定", "単位数", "無料"],
  openGraph: {
    title: "介護報酬計算機【令和6年改定対応・無料】",
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: { "@type": "Answer", text: "はい。2024年4月・6月施行の最新介護報酬改定に対応しています。次回改定は令和9年度予定です。" },
        },
        {
          "@type": "Question",
          name: "加算や減算も計算できますか?",
