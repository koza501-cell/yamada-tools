    ...
    <div className="min-h-screen pb-24">
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto px-4 mb-8" style={{maxWidth: '100%'}}>
          <ExpertSupervision
            sources={[{ name: '国税庁 消費税の免税事業者', url: 'https://www.nta.go.jp/taxes/shiraberu/taxanswer/shohi/6501.htm' }, { name: '日本政策金融公庫 創業融資', url: 'https://www.jfc.go.jp/n/finance/search/01_sougyo_m.html' }]}
            lastUpdated="2026年5月"
