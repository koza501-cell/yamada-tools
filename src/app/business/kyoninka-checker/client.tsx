...
const LICENSE_DATA: LicenseInfo[] = [
  ...
  { id: 'minpaku', category: '旅行・観光', business: '民泊（住宅宿泊事業）', licenseName: '住宅宿泊事業届出', type: 'notification', authority: '都道府県知事', estimatedDays: '約1〜2週間', estimatedCost: 'なし（届出無料）', capitalReq: 'なし', qualifications: 'なし', penalty: '6か月以下の懲役または100万円以下の罰金', teikanMokuteki: '住宅宿泊事業', notes: '年間180日の上限あり。自治体の条例で制限される場合も' },
