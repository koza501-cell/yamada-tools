    ...
    <div className="min-h-screen pb-24">
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto px-4 mb-8" style={{maxWidth: '100%'}}>
          <ExpertSupervision
            sources={[{ name: '法務局 登記手続案内', url: 'https://houmukyoku.moj.go.jp/homu/touki2.html' }, { name: '日本公証人連合会', url: 'https://www.koshonin.gr.jp/' }, { name: '内閣府 国民の祝日', url: 'https://www8.cao.go.jp/chosei/shukujitsu/gaiyou.html' }]}
            lastUpdated="2026年5月"
