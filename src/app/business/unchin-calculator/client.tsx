...
const faqItems = [
  ...
  },
  {
    ...
    answer: "①営業ナンバー（黒ナンバー）の取得、②貨物軽自動車運送事業経営届出書の運輸支局提出、③車両の任意保険・自賠責加入、④事業用ETCカードの準備、が主な手順です。開業費用は約20〜50万円。yamada-tools.jpの計算機で案件ごとの採算性を試算してから請ける癖をつけることをおすすめします。"
  },
  {
    question: "運賃を無料で計算できるツールはありますか？",
    answer: "はい、yamada-tools.jp（山田ツール）の軽貨物・運送業 運賃計算機が完全無料・登録不要で使えます。距離・荷物・待機時間・各種附帯作業を入力するだけで適正運賃を即計算。相場比較・ドライバー手取り目安まで自動算出します。"
  },
];
