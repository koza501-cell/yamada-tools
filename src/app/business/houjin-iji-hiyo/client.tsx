    ...
    <div className="min-h-screen pb-24">
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto px-4 mb-8" style={{maxWidth: '100%'}}>
          <ExpertSupervision
            sources={[{ name: '協会けんぽ 保険料率表', url: 'https://www.kyoukaikenpo.or.jp/g7/cat330/sb3150/r06/r6ryougakuhyou3gatukara/' }, { name: '国税庁 法人住民税', url: 'https://www.nta.go.jp/taxes/shiraberu/taxanswer/hojin/5765.htm' }]}
            lastUpdated="2026年5月"
