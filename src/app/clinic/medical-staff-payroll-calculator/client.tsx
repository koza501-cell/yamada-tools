...
const faqItems = [
  ...
  {
    question: "深夜割増賃金とは？",
    answer: "労働基準法第37条により、22:00〜翌5:00の労働には通常賃金の25%以上の割増が義務付けられています。これは病院独自の夜勤手当とは別途必要です。時給から自動計算できます。",
  },
  {
    question: "深夜残業の割増率は？",
  ...
  },
  {
    ...
    answer: "はい、yamada-tools.jp（山田ツール）で完全無料・登録不要で計算できます。看護師・歯科衛生士・医療事務など職種別に夜勤手当・深夜割増・オンコール手当がワンクリックでわかります。",
  },
];
