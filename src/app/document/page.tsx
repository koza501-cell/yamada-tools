...
export default function DocumentToolsPage() {
  const availableTools = documentTools.filter(t => t.available);
  const comingSoonTools = documentTools.filter(t => !t.available);
    ...
    <div className="min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl font-bold text-kon mb-4">書類作成ツール</h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            請求書、見積書、履歴書、電子印鑑など、日本のビジネスに必要な書類を
            簡単に作成できます。登録不要・完全無料。
          </p>
        </div>
