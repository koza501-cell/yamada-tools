...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://yamada-tools.jp/terms',
  },
};
          ...
          <div className="space-y-8 text-gray-700">
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed mb-2">
                本サービスは、PDFファイルの編集、画像変換、文書作成など、各種オンラインツールを提供するものです。無料プラン、有料のPROプラン、法人向けTEAMプラン・ENTERPRISEプラン、およびデイパス（1日・3日・7日）をご用意しています。
              </p>
              <p className="text-sm leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4 text-sm">
                ...
                <div>
                  ...
                  <p>PROプランには10日間の無料体験期間があります。無料体験期間中は課金されません。無料体験期間終了後、解約しない場合は選択されたプランの料金が自動的に課金されます。解約した場合は無料プランへ移行します。</p>
                </div>
                <div>
