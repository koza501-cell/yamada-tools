...
export const niches: Niche[] = [
  {
    ...
    name: "ビジネス書類",
    shortName: "ビジネス",
    description: "請求書・全銀・電子印鑑・🆕法人検索",
    toolCount: 28,
    theme: "blue",
    featured: true,
    popularBadge: "人気 №1",
    topTools: ["請求書", "封筒印刷", "全銀", "🆕法人検索"],
    featuredLinks: [
      { name: "請求書作成", url: "/document/invoice" },
      { name: "全銀フォーマット", url: "/convert/bank-format" },
      { name: "🆕 法人検索", url: "/business/houjin-search" },
      { name: "🆕 補助金検索", url: "/business/hojokin-active" },
    ],
    url: "/document",
  },
  {
