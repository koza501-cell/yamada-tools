...
- Name: feature-a-e2e-test.spec.ts >> Part 2: Feature A - Bulk Mail-Merge Engine >> 2.2: Data Grid displays all rows with columns (BUG #1)
- Location: feature-a-e2e-test.spec.ts:80:7
