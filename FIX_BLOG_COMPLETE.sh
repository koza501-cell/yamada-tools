...
echo "🔧 COMPLETE BLOG FIX - ALL FILES AT ONCE"

# 1. Fix admin page.tsx
cat > src/app/admin/blog/page.tsx << 'EOFADMIN'
'use client';
...
# 2. Fix publish API
cat > src/app/api/admin/blog/publish/route.ts << 'EOFPUBLISH'
...
echo "✅ Files created!"
echo "Building..."
npm run build && pm2 restart yamada-frontend && pm2 save
